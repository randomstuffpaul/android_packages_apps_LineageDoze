...
public class LineageDozeService extends Service {
    private static final String TAG = "LineageDozeService";
    ...
    private LineageProximitySensor mSensor;
    ...
    class LineageProximitySensor implements SensorEventListener {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "LineageDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new LineageProximitySensor(mContext);
